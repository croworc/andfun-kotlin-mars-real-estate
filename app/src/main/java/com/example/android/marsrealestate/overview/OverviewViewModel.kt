...
class OverviewViewModel : ViewModel() {
    ...
    private fun getMarsRealEstateProperties() {
        // COMPLETED (05) Call coroutineScope.launch and place the rest of the code in it
    ...
    } // close function getMarsRealEstateProperties()

    // COMPLETED (08) Cancel the Coroutine Job when the ViewModel is finished in onCleared

...
// COMPLETED (01) Create an enum full of constants to match the query values our web service expects
...
interface MarsApiService {
     ...
     * HTTP method
     */
    // COMPLETED (02) Add filter @Query value to the getProperties method
    @GET("realestate")
